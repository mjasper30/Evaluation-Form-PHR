...
<body>
    <svg style="display: none">
        ...
        <symbol id="questions" viewBox="0 0 16 16">
    ...
    <header class="page-header">
        <nav>
            <a href="#0" aria-label="forecastr logo" class="logo">
                <img src="images/phr-logo.png" style="width: 100px; height: 70px" srcset="">
            </a>
            ...
            <ul class="admin-menu">
                ...
                <li>
                    <a>
                        ...
                        <span onclick="logOut()"></i>Logout</span>
                    </a>
                </li>
                <li>
                    <div class="switch">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button onclick="addQuestion()" type="submit" name="addQuestionName"
                                    class="btn btn-primary"><i class="bi bi-plus-lg"></i> Add Question</button>
                            </div>
                            </form>
                        </div>
                    </div>
